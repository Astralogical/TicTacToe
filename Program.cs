    ...
    internal class Program
    {
        ...
        static int CheckWin()
        {
            if (spaces[0] == spaces[1] &&
                ...
                spaces[0] == spaces[3] &&
                spaces[3] == spaces[6] || //col 1
                spaces[1] == spaces[4] &&
                spaces[4] == spaces[7] || //col 2
                spaces[2] == spaces[5] &&
                spaces[5] == spaces[8] || //col 3
                spaces[0] == spaces[4] &&
        ...
        static void Main(string[] args)
        {
            do
            {
                ...
                { 
                    ...
                    Console.WriteLine("Please wait a couple seconds the board is refreshing...");
                    Thread.Sleep(2000);
                }
                flag = CheckWin();
            } while (flag!= 1 && flag != -1);
